...
export class BookController {
  ...
  getAllBooks = async (_req: Request, res: Response<BooksResponse | ErrorResponse>): Promise<void> => {
    try {
  ...
  getBookById = async (req: Request, res: Response<BookResponse | ErrorResponse>): Promise<void> => {
    try {
      const { id } = req.params;
